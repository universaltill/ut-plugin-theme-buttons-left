...
{
  "id": "com.universaltill.theme-buttons-left",
  "name": "Buttons Left Theme",
  "version": "1.0.0",
  "runtime": "none",
  "device_arch": "any",
...
JSON
    ...
    echo "# Buttons Left theme" >"${case_dir}/README.md"
...
fresh_repo
echo "# Buttons Left theme, updated" >"${case_dir}/README.md"
commit_change
